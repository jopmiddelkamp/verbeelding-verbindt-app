...
echo "flutter gen-l10n shared_localizations"
...
echo "flutter gen-l10n intro_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n artist_details_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n guide_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n scan_qr_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n select_interests_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n completed_page_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n device_info_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n error_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n not_implemented_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n permissions_denied_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n permissions_removed_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n permissions_restricted_dialog_localizations"
fvm flutter gen-l10n \
...
echo "flutter gen-l10n confirm_dialog_localizations"
fvm flutter gen-l10n \
