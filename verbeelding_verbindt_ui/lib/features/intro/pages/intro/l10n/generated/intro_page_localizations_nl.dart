...
import 'intro_page_localizations.dart';

/// The translations for Dutch Flemish (`nl`).
class IntroPageLocalizationsNl extends IntroPageLocalizations {
  IntroPageLocalizationsNl([String locale = 'nl']) : super(locale);
