...
class _CompletedPageLocalizationsDelegate extends LocalizationsDelegate<CompletedPageLocalizations> {
  ...
  Future<CompletedPageLocalizations> load(Locale locale) {
    return SynchronousFuture<CompletedPageLocalizations>(lookupCompletedPageLocalizations(locale));
  }
...
CompletedPageLocalizations lookupCompletedPageLocalizations(Locale locale) {
