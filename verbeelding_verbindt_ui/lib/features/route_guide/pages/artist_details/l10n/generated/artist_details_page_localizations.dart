...
class _ArtistDetailsPageLocalizationsDelegate extends LocalizationsDelegate<ArtistDetailsPageLocalizations> {
  ...
  Future<ArtistDetailsPageLocalizations> load(Locale locale) {
    return SynchronousFuture<ArtistDetailsPageLocalizations>(lookupArtistDetailsPageLocalizations(locale));
  }
...
ArtistDetailsPageLocalizations lookupArtistDetailsPageLocalizations(Locale locale) {
