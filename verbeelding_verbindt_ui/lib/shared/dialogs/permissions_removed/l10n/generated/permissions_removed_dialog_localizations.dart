...
class _PermissionsRemovedDialogLocalizationsDelegate extends LocalizationsDelegate<PermissionsRemovedDialogLocalizations> {
  ...
  Future<PermissionsRemovedDialogLocalizations> load(Locale locale) {
    return SynchronousFuture<PermissionsRemovedDialogLocalizations>(lookupPermissionsRemovedDialogLocalizations(locale));
  }
...
PermissionsRemovedDialogLocalizations lookupPermissionsRemovedDialogLocalizations(Locale locale) {
