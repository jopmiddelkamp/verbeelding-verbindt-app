...
class _PermissionsDeniedDialogLocalizationsDelegate extends LocalizationsDelegate<PermissionsDeniedDialogLocalizations> {
  ...
  Future<PermissionsDeniedDialogLocalizations> load(Locale locale) {
    return SynchronousFuture<PermissionsDeniedDialogLocalizations>(lookupPermissionsDeniedDialogLocalizations(locale));
  }
...
PermissionsDeniedDialogLocalizations lookupPermissionsDeniedDialogLocalizations(Locale locale) {
