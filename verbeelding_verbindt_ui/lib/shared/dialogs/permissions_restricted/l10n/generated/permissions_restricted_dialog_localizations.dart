...
class _PermissionsRestrictedDialogLocalizationsDelegate extends LocalizationsDelegate<PermissionsRestrictedDialogLocalizations> {
  ...
  Future<PermissionsRestrictedDialogLocalizations> load(Locale locale) {
    return SynchronousFuture<PermissionsRestrictedDialogLocalizations>(lookupPermissionsRestrictedDialogLocalizations(locale));
  }
...
PermissionsRestrictedDialogLocalizations lookupPermissionsRestrictedDialogLocalizations(Locale locale) {
