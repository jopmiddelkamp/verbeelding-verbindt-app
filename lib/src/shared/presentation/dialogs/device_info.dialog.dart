...
import '../../domain/models/package_info_model.dart';
...
class DeviceInfoDialog extends StatelessWidget {
  ...
  List<Widget> _generalContent(
    ...
    final package = serviceLocator<PackageInfoModel>();
    return [
      ..._buildTile(
        context,
        'Package name',
  ...
  List<Widget> _iOSContent(
    ...
    final device = serviceLocator<IosDeviceInfoModel>();
    return [
      ..._buildTile(
        context,
        'Physical device?',
  ...
  List<Widget> _androidContent(
    ...
    final device = serviceLocator<AndroidDeviceInfoModel>();
    return [
      ..._buildTile(
        context,
        'Physical device?',
  ...
  List<Widget> _environment(
    ...
    final environment = serviceLocator<EnvironmentVariables>();
    return [
      ..._buildTile(
        context,
        'Environment',
