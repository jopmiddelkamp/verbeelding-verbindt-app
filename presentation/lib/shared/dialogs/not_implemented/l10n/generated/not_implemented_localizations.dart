...
abstract class NotImplementedDialogLocalizations {
  NotImplementedDialogLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static NotImplementedDialogLocalizations of(BuildContext context) {
    return Localizations.of<NotImplementedDialogLocalizations>(context, NotImplementedDialogLocalizations)!;
  }

  static const LocalizationsDelegate<NotImplementedDialogLocalizations> delegate = _NotImplementedDialogLocalizationsDelegate();
...
class _NotImplementedDialogLocalizationsDelegate extends LocalizationsDelegate<NotImplementedDialogLocalizations> {
  const _NotImplementedDialogLocalizationsDelegate();

  @override
  Future<NotImplementedDialogLocalizations> load(Locale locale) {
    return SynchronousFuture<NotImplementedDialogLocalizations>(_lookupNotImplementedDialogLocalizations(locale));
  }
...
NotImplementedDialogLocalizations _lookupNotImplementedDialogLocalizations(Locale locale) {
  


// Lookup logic when only language code is specified.
switch (locale.languageCode) {
  case 'nl': return NotImplementedDialogLocalizationsNl();
}
